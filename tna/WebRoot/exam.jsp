	...
	<div class="content">
		...
		<form action="checkanswer.do" method="post">
			<c:forEach var="item" items="${requestScope.items }"
				...
				<h2>${status.index}.${item.question }</h2>
				<input type="radio" name="question${item.qid}" id="optionsRadios1"
					value="A"> A.${item.option_a }
					<br>
				<input type="radio" name="question${item.qid }" id="optionsRadios2"
					value="B"> B.${item.option_b }
					<br>
				<input type="radio" name="question${item.qid }" id="optionsRadios3"
					value="C"> C.${item.option_c }
					<br>
				<input type="radio" name="question${item.qid }" id="optionsRadios4"
					value="D"> D.${item.option_d }
					</c:forEach>
			<br>
			<br>
