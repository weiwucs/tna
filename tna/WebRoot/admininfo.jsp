					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab" action="personalinfo.do" method="post">
								...
								<div class="form-group">
									<label>Name</label> <input type="text" value="${user.name }"
								...
								<div class="form-group">
									<label>Okpassword</label> <input type="text"
										value="${user.password }" name="okpassword"
										class="form-control">
								</div>
								...
								<div class="form-group">
									<input type="hidden" value="${user.admintype }"
										name="admintype" class="form-control">
								</div>
