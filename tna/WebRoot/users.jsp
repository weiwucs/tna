	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="dashboard-menu nav nav-list collapse in">
					<li><a href="adminindex.jsp"><span class="fa fa-caret-right"></span>
							Home</a></li>
					<li class="active"><a href="users.do"><span
							class="fa fa-caret-right"></span> Users</a></li>
					<li><a href="admininfo.jsp"><span class="fa fa-caret-right"></span>
							User Profile</a></li>
					<li><a href="questions.do"><span class="fa fa-caret-right"></span>
							Questions</a></li>
					<li><a href="scores.do"><span
							class="fa fa-caret-right"></span> Scores</a></li>
				</ul></li>
			...
			<table class="table">
				...
				<c:forEach var="user" items="${requestScope.users }" varStatus="status">
					<tr>
						...
						<td><a href="users.do"><i class="fa fa-pencil"></i></a> <a
