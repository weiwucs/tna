        ...
        <div class="panel-body">
            <form action="login.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control span12" name="telephone">
                </div>
                <div class="form-group">
                    <label>Idnumber</label>
                    <input type="text" class="form-control span12" name="idnumber">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control span12" name="okpassword">
                </div>
                <div class="form-group">
