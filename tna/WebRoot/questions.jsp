...
.navbar-default .navbar-brand, .navbar-default .navbar-brand:hover {
	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="dashboard-menu nav nav-list collapse in">
					<li><a href="adminindex.jsp"><span
							class="fa fa-caret-right"></span> Home</a></li>
					<li><a href="users.do"><span class="fa fa-caret-right"></span>
							Users</a></li>
					<li><a href="admininfo.jsp"><span class="fa fa-caret-right"></span>
							User Profile</a></li>
					<li><a href="questions.do"><span
							class="fa fa-caret-right"></span> Questions</a></li>
					<li><a href="scores.do"><span class="fa fa-caret-right"></span>
							Scores</a></li>
				</ul></li>
	...
	<div class="content">
		...
		<div class="main-content">
			...
			<div class="box-content">
				...
				<div class="btn-toolbar list-toolbar">
					<a class="btn btn-primary" href="insertquestion.jsp">
				...
				<table
					...
					<tbody>
						...
						<tr>
							...
							<td class="center">${item.option_a }</td>
							<td class="center">${item.option_b }</td>
							<td class="center">${item.option_c }</td>
							<td class="center">${item.option_d }</td>
							<td class="center">${item.answer }</td>
							<td class="center">
							<a class="btn btn-info" href="toupdatequestion.do?qid=${item.qid }"> <i
									class="glyphicon glyphicon-edit icon-white"></i> Edit
							</a> <a class="btn btn-danger" href="deletequestion.do?qid=${item.qid }"> <i
		...
		<footer>
			...
			<p>
				© 2017 <a href="http://www.portnine.com" target="_blank">Portnine</a>
			</p>
		</footer>
	</div>
	</div>
