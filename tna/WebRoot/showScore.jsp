...
.navbar-default .navbar-brand, .navbar-default .navbar-brand:hover {
	...
	<div class="content">
		...
		<div class="body">
			...
			<h3>Your Score:</h3><br>
			<p>${requestScope.score.score }</p><br>
			<h3>Your Answer:</h3><br>
			<p>${requestScope.score.answer }</p><br>
			<h3>True Answer:</h3><br>
			<p>${requestScope.score.s_answer }</p><br>
			<h3>Exam Time:</h3>
			<p>${requestScope.score.data }</p>
		</div>
