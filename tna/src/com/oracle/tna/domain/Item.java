...
public class Item {
	...
	public Item(int qid, String question, String option_a, String option_b, String option_c, String option_d,
			String answer) {
		super();
		this.qid = qid;
	...
	public String toString() {
		return "Item [qid=" + qid + ", question=" + question + ", option_a=" + option_a + ", option_b=" + option_b
